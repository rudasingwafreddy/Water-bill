...
<html>
    ...
    <body>
        ...
        <div class="container"  id="content" style="margin-left:30%;">

            <h2 style="color: blue;">Buy me a coffee &ensp;<a href="http://softechsupply.com/scholarships/">Back</a> </h2>
            <br>
            <div class="row">
                <div class="col-xs-12 col-md-4">
                    ...
                    <h3 class="panel-title display-td"> &nbsp;Payment Details<?php //echo $_GET['id'];?></h3>
                        ...
                        <div class="panel-body">
                            ...
                            <!-- Payment form -->
                            <form role="form" action="pay.php" method="POST" id="payment-form">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="options" placeholder="amount" id="price" required/>
                                        </div>
                                    </div>                        
                                </div>
