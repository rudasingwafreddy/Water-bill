...
<form action="processLeave.php?action=addUser" method="post"  name="frmListUser" id="frmListUser">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="text">
	...
	// 		WHERE empid = $cust_id and status='Process'";
	$sql = "SELECT * FROM tbl_bill 
			WHERE empid = $cust_id and status!='Confirmed'";
	$result = dbQuery($sql);
	$i=0;
    ...
    <tr class="<?php echo $class; ?>" style="height:25px;">
	  ...
	  <td width="150" align="center"><a href="view.php?mod=employee&view=billconfirm&billid=<?php echo $billid; ?>">Confirm</a></td>
    </tr>
    <?php
	} // end while
	?>
