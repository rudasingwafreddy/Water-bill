...
mysql_query("insert into tbl_payment values('','$clid','$names','$addr','$phones','$cons','$bamount','$amtpen','$tot','$mters',NOW(),'Process','$empids','$mbill')");

mysql_query("update tbl_bill set status='Process' where billid='$mbill'");
...
<!-- <form action="view.php?mod=customer&view=billPayment" method="POST"> -->
<form action="https://dht.softechsupply.com/Flutterwave/pay_honorine.php" method="POST">
...
<table id="cltable"><tr>
			...
			<td><input type="submit" name="myBtn" id="myBtn" value="Pay" onclick="return validat();"/></td>
