...
<html>
<head>
<title>Water Billing Management System - Register</title>
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
 <tr> 
  <td><img src="images/wasac1.png" id="imgleft"  >
		 ...
		 <div class="errorMessage" align="center"><?php echo $errorMessage; ?></div>
		  ...
		  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
           ...
           <tr class="entryTable">
             ...
             <td class="content"><input name="txtMob" type="text" class="box" id="txtMob" value="" size="30" maxlength="13" /></td>
           </tr>
		   
           <tr class="entryTable">
             <td class="label"> &nbsp;E-mail</td>
            <td class="content"><input name="Email" type="Email" class="box" id="Email" value="" size="30" maxlength="60"></td>
           </tr>
